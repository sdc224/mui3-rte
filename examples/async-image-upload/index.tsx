...
const UploadImagePopoverComponent: FunctionComponent<IUploadImagePopoverProps> = ({
	classes,
	...props
}) => {
...
const UploadImagePopover = withStyles(cardPopverStyles)(
			...
			<MUIRichTextEditor
				...
				draftEditorProps={{
					handleDroppedFiles: (_selectionState, files) => {
						if (
							files.length &&
							(files[0] as File).name !== undefined
						) {
