...
const cardPopverStyles = createStyles({
	root: {
		padding: 10,
		maxWidth: 350
	},
...
const MyCardComponent: FunctionComponent<any> = (props) => {
	...
	return (
		<Card className={classes.root}>
			<CardHeader
				...
				subheader={
					blockProps.date && blockProps.date.toLocaleDateString()
				}
			/>
			<CardMedia
...
const MyCard = withStyles(cardStyles)(MyCardComponent);

const MyCardPopoverComponent: FunctionComponent<IMyCardPopoverProps> = ({
	classes,
	...props
}) => {
...
const MyCardPopover = withStyles(cardPopverStyles)(MyCardPopoverComponent);
