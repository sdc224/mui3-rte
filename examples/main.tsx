...
const App = () => {
	...
	return (
		<div>
			...
			<button onClick={() => setSample(<Decorators />)}>
				Decorators
			</button>
			...
			<button onClick={() => setSample(<LoadHTML />)}>
				Load from HTML
			</button>
			<button onClick={() => setSample(<ResetValue />)}>
				Reset value
			</button>
			<button onClick={() => setSample(<KeyBindings />)}>
				Key Bindings
			</button>
			<button onClick={() => setSample(<MaxLength />)}>Max length</button>
			<button onClick={() => setSample(<Autocomplete />)}>
				Autocomplete
			</button>
